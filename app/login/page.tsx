      ...
      <div className="mx-auth-wrap">
        <div className="mx-auth-card">
          <div className="mx-logo" style={{ justifyContent: "center", marginBottom: 16 }}>
            ...
            <span style={{ color: "#00FF88" }}>_PRO</span>
          ...
          <form onSubmit={handleSubmit}>
            <div className="mx-field">
              <label>EMAIL</label>
              <input type="email" required value={email} onChange={(e) => setEmail(e.target.value)} placeholder="trader@exness.com" className="mx-input" />
            </div>
            <div className="mx-field">
              <label>PASSWORD</label>
              <input type="password" required minLength={6} value={password} onChange={(e) => setPassword(e.target.value)} placeholder="minimal 6 karakter" className="mx-input" />
            </div>
